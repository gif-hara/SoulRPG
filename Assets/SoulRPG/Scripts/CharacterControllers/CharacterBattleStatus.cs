    ...
    public sealed class CharacterBattleStatus : IDisposable
    {
        ...
        public CharacterBattleStatus(Character character, Define.AllyType allyType)
            ...
            (
                ...
                character.GrowthParameter.PhysicalStrength + character.Equipment.TotalPhysicalAttack,
                character.GrowthParameter.MagicalStrength + character.Equipment.TotalMagicalAttack,
                ...
                character.GrowthParameter.Speed + character.Equipment.TotalSpeed + character.Equipment.TotalSpeed,
                0,
                character.GrowthParameter.BehaviourPoint,
                0,
                character.Attribute,
                allyType
            )
        ...
        public CharacterBattleStatus(MasterData.Enemy enemy)
            : this
            (
                enemy.Name.Localized().Replace("{SealedName}", SaveData.LoadSafe().playerData.sealedName),
                enemy.HitPoint,
                enemy.HitPoint,
                enemy.Stamina,
                enemy.Stamina,
